...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  // REMOVED Welcome from sidebar - only show for dashboard pages
  const navigation = [
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed md:relative z-30 w-64 bg-blue-800 text-white
      ...
      `}>
        <div className="p-4 flex items-center justify-between border-b border-blue-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Devure</h1>
              <p className="text-sm text-blue-200">Business Management</p>
            </div>
          </div>
          <button 
